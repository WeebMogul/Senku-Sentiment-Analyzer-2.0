...
for ep in range(1, Slime_anime_max_ep):
    ...
    pos_df['Comment'] = pos_df['Comment'].str.replace('[^\w\s]', ' ')
    comment_words = pos_df['Comment'].apply(word_tokenize)
    ...
    stopwords_json = {
        "en": ["a", "a's", "able", "about", "above", "according", "accordingly", "across", "actually", "after",
               ...
               "know", "known", "knows", "l", "last", "lately", "later", "latter", "latterly", "least", "less", "lest",
               ...
               "us", "use", "used", "useful", "uses", "using", "usually", "uucp", "v", "value", "various", "very",
               ...
               "whether", "which", "while", "whither", "who", "who's", "whoever", "whole", "whom", "whose", "why",
               "will", "willing", "wish", "with", "within", "without", "won't", "wonder", "would", "wouldn't", "x", "y",
    ...
    print(sum_of_tfidf.sort_values(ascending=False))
